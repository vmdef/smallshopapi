...
public class CustomerRepresentationModelAssembler extends RepresentationModelAssemblerSupport<CustomerEntity, Customer> {
     ...
     */
    public CustomerRepresentationModelAssembler(UserRepresentationModelAssembler uAssembler) {
        super(CustomerController.class, Customer.class);
        this.uAssembler = uAssembler;
    }

    /**
     * Coverts the Customer entity to resource
     *
     * @param entity
     */
    @Override
...
/*                .createdBy(uAssembler.toModel(entity.getCreatedBy()))
                .modifiedBy(uAssembler.toModel(entity.getModifiedBy()));*/
